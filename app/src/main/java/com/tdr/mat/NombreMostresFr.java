...
public class NombreMostresFr extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		lin = getView().findViewById(R.id.lin);
		for (int i = 0; i < n; i++) {
	...
	public void onStart() {
		...
		final Button ok = getView().findViewById(R.id.button1);
		final Button afegirmostra = getView().findViewById(R.id.afegirmostra);
		final Button treumostra = getView().findViewById(R.id.treumostra);
		...
		treumostra.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View view) {
				...
				EditText mostra = getView().findViewById(n - 1);
		...
		ok.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View view) {
				v = new double[n];
				for (int i = 0; i < n; i++) {
					EditText mostra = getView().findViewById(i);
					try {
