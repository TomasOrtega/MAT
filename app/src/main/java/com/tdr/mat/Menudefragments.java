...
public class Menudefragments extends Fragment {
	...
	public void onStart() {
		super.onStart();
		final Button esg = getView().findViewById(R.id.button1);
		final Button det = getView().findViewById(R.id.button2);
		final Button seq = getView().findViewById(R.id.button3);
		final Button nwt = getView().findViewById(R.id.button4);
		final Button est = getView().findViewById(R.id.button5);
		final Button tri = getView().findViewById(R.id.button6);
