...
public class TrianglesFr extends Fragment {
	...
	public void onStart() {
		super.onStart();
		final EditText atext = getView().findViewById(R.id.editText1);
		final EditText btext = getView().findViewById(R.id.editText2);
		final EditText ctext = getView().findViewById(R.id.editText3);
		final EditText alphatext = getView().findViewById(R.id.editText4);
		final EditText betatext = getView().findViewById(R.id.editText5);
		final EditText gammatext = getView().findViewById(R.id.editText6);
		final ImageButton button = getView().findViewById(R.id.imageButton1);
		final Button buidar = getView().findViewById(R.id.button1);
