...
public class Esg extends Fragment {
	...
	public void onStart() {
		...
		final Button button = getView().findViewById(R.id.button1);
		final TextView Resultatescrit1 = getView().findViewById(R.id.textView2);
		final TextView Resultatescrit2 = getView().findViewById(R.id.textView3);
